<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Especificos.aspx.cs" Inherits="Gestion_de_riesgos_2.Especificos" %>
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
                        ...
                        <br />
						<header class="major">
							<h2>Identificación de Riesgos Específicos</h2>
						</header>
                     <div style=" max-height:300px;overflow-y:scroll;overflow-x: scroll">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                            <Columns>
                                <asp:BoundField DataField="ObjetivoProceso" HeaderText="Objetivo de Proceso" SortExpression="ObjetivoProceso" />
                                <asp:BoundField DataField="CodigoRiesgo" HeaderText="Codigo Riesgo" SortExpression="CodigoRiesgo" />
                                <asp:BoundField DataField="Causa_específica" HeaderText="Causa específica" SortExpression="Causa_específica" />
                                <asp:BoundField DataField="Area_de_riesgo_directo_o_indirecto" HeaderText="Area de riesgo" SortExpression="Area_de_riesgo_directo_o_indirecto" />
                                <asp:BoundField DataField="Dependencia_de_riesgo_directo_o_indirecto" HeaderText="Dependencia de riesgo" SortExpression="Dependencia_de_riesgo_directo_o_indirecto" />
                            </Columns>
                          </asp:GridView>

                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GestionConnectionString3 %>" SelectCommand="SELECT [ObjetivoProceso], [CodigoRiesgo], [Causa específica] AS Causa_específica, [Area de riesgo directo o indirecto] AS Area_de_riesgo_directo_o_indirecto, [Dependencia de riesgo _directo o indirecto] AS Dependencia_de_riesgo_directo_o_indirecto FROM [Ident_Riesgos_Especificos]"></asp:SqlDataSource>
                         </div>
                        <br />
                        <br />
                        <div class="col-12">
