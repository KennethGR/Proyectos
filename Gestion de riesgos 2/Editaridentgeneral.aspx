<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editaridentgeneral.aspx.cs" Inherits="Gestion_de_riesgos_2.Editaridentgeneral" %>
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
                        ...
                        <br />
						<header class="major">
							<h2>Editar Registro de Identificación de Riesgos Generales</h2>
						</header>
                        <div class="col-12">
                        ...
                        <br />
                        <h1>Código:</h1>
                        <asp:TextBox ID="codi" runat="server" Width="300px" Height="27px" class="primary" ReadOnly="True"></asp:TextBox>
                        <br />
                        <br />
						</div>
						<!-- Form -->
