<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editarusuario.aspx.cs" Inherits="Gestion_de_riesgos_2.editarusuario" %>
				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li style="white-space: nowrap;"><a href="index.aspx" class="button primary">Salir</a></li>
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
                        ...
                        <div class="col-12">
                        <br />
                        <h1>&nbsp;Nombre de funcionario responsable:</h1>
                        <asp:TextBox ID="codcausa" class="primary" runat="server" Height="50px" Width="600px" ReadOnly="True"></asp:TextBox>
                            <br />
                            <br />
                            </div>
                         <div class="col-12">
                       ...
                       <div class="col-12">
                        ...
                        <asp:TextBox ID="subcat" class="primary" runat="server" Height="50px" Width="500px"></asp:TextBox>
                            <br />
                            <br />
						</div>
                        <div class="col-12">
                        <h1>Seleccione el Rol:</h1>
                            <asp:DropDownList ID="DropDownList3" class="primary" runat="server" Height="50px" Width="400px">
                                ...
                                <asp:ListItem>Gestionador de Riesgos</asp:ListItem>
                            </asp:DropDownList>
                             <br />
                             <br />
						 </div>
