<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantAdministracion.aspx.cs" Inherits="Gestion_de_riesgos_2.MantAdministracion" %>
				...
				<div id="main" class="wrapper style1">
					<div class="container">
                        <header class="major">
                            <br />
                            <br />
							<h2>Mantenimiento de administracion de riesgos institucionales</h2>
						</header>
						<div class="table-wrapper">
                            <br />
                            <br />
                            <a href="agregarAdmi.aspx">Agregar nuevo registro de Administración de Riesgos</a>
                            <br />
                            <br />
                        </div>
                        <div style=" max-height:300px;overflow-y:scroll;overflow-x: scroll">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="event1" HeaderText="Evento" />
                                    <asp:BoundField DataField="tipo" HeaderText="Tipo de Riesgo" />
                                    <asp:BoundField DataField="tolerancia" HeaderText="Tolerancia de Riesgo" />
                                    <asp:BoundField DataField="nivel1" HeaderText="Nivel De Riesgo Inherente" />
                                    <asp:BoundField DataField="nivel2" HeaderText="Nivel de Riesgo Residual 1" />
                                    <asp:BoundField DataField="nivel3" HeaderText="Nivel de Riesgo Residual 2" />
                                    <asp:TemplateField HeaderText="Opcion">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" runat="server"  OnClientClick="return confirm('Estas Seguro de eliminar?')" OnClick="LinkButton1_Click">Eliminar</asp:LinkButton> | <a href="editaradmi.aspx?cod=<%# Eval("cod") %>">Editar</a>
                                            <asp:HiddenField ID="HiddenFieldAdmin" runat="server" Value='<%# Eval("cod") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GestionConnectionString3 %>" SelectCommand="SELECT [Codigo], [Evento], [Tipo de riesgo] AS Tipo_de_riesgo, [Tolerancia del Riesgo] AS Tolerancia_del_Riesgo, [NiveldelRiesgo inherente] AS NiveldelRiesgo_inherente, [NiveldelRiesgoResidual1], [NiveldelRiesgoresidual2] FROM [Administracion1]"></asp:SqlDataSource>
                        </div>
						<!-- Form -->
...
<!-- Scripts -->
        ...
        <div id="navPanel">
            ...
            <a class="link depth-0" href="index.aspx" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"><span class="indent-0"></span>Salir</a>
            </nav>
        </div>
            <%--  --%>
	</form>
