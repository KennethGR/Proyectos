...
{
    public partial class Administración : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            {
                if(codigo.SelectedValue=="-Seleccione el codigo-")
                {
                    Response.Write("<script>window.alert('Seleccione una opcion valida');</script>");
                    Tipo.Text = "";
                    Tolerancia.Text = "";
                    resultado.Text = "";
                    TextBox9.Text = "";
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        "alert",
                        "alert('Registro Existoso');window.location ='Administracion.aspx';",
                        true);
                        }
                        catch
                        {
