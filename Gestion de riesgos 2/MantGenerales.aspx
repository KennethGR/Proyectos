<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantGenerales.aspx.cs" Inherits="Gestion_de_riesgos_2.MantGenerales" %>
					...
					<nav id="nav">
						<ul>
							...
							<ul class="" style="user-select: none; display: none; position: absolute;">
							        ...
							        <li style="white-space: nowrap;"><a href="MantUsuario.aspx" style="display: block;">Usuarios</a></li>	
                            </ul>
                            </li>
				...
				<div id="main" class="wrapper style1">
					<div class="container">
                        <header class="major">
                            <br />
                            <br />
							<h2>Mantenimiento de Identificación de Riesgos Generales</h2>
						</header>
						<div class="table-wrapper">
                            <br />
                            <br />
                            <a href="agregaridentriesgoG.aspx">Agregar nuevo registro de identificación de riesgos generales</a>
                            <br />
                            <br />
                        </div>
                        <div style=" max-height:300px;overflow-y:scroll;overflow-x:scroll">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="codigocausa" HeaderText="Codigo de Causa" />
                                    <asp:BoundField DataField="causafactor" HeaderText="Causa (Factor)" />
                                    <asp:BoundField DataField="categoria" HeaderText="Categoría" />
                                    <asp:BoundField DataField="subcat" HeaderText="SubCategoría" />
                                    <asp:TemplateField HeaderText="Opcion">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButtonborra" OnClientClick="return confirm('Estas Seguro de eliminar?')" runat="server" OnClick="LinkButton1_Click">Eliminar</asp:LinkButton> | <a href="Editaridentgeneral.aspx?codriesgo=<%# Eval("codriesgo") %>">Editar</a>
                                            &nbsp;<asp:HiddenField ID="HiddenFieldGen" runat="server" Value='<%# Eval("codriesgo") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GestionConnectionString3 %>" SelectCommand="SELECT [CodigodeRiesgo], [ObjetivoProceso], [CodigoCausa], [CausaFactor], [Categoría  del Factor] AS Categoría_del_Factor, [SubCategoría del Factor] AS SubCategoría_del_Factor FROM [Ident_Riesgos_Generales]"></asp:SqlDataSource>
                        </div>
						<!-- Form -->
