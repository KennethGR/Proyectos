<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generales.aspx.cs" Inherits="Gestion_de_riesgos_2.Generales" %>
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
                        ...
                        <br />
						<header class="major">
							<h2>Identificación de Riesgos Generales</h2>
						</header>
                        <div style=" max-height:280px;overflow-y:scroll;overflow-x: scroll">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2">
                            <Columns>
                                <asp:BoundField DataField="CodigodeRiesgo" HeaderText="Codigo de Riesgo" SortExpression="CodigodeRiesgo" />
                                <asp:BoundField DataField="ObjetivoProceso" HeaderText="Objetivo de Proceso" SortExpression="ObjetivoProceso" />
                                <asp:BoundField DataField="CodigoCausa" HeaderText="Codigo Causa" SortExpression="CodigoCausa" />
                                <asp:BoundField DataField="CausaFactor" HeaderText="Causa(Factor)" SortExpression="CausaFactor" />
                                <asp:BoundField DataField="Descripcion" HeaderText="Descripcion" SortExpression="Descripcion" />
                                <asp:BoundField DataField="Fuente" HeaderText="Fuente" SortExpression="Fuente" />
                            </Columns>
                          </asp:GridView>
                          <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:GestionConnectionString3 %>" SelectCommand="SELECT [CodigodeRiesgo], [ObjetivoProceso], [CodigoCausa], [CausaFactor], [Descripcion], [Fuente] FROM [Ident_Riesgos_Generales]"></asp:SqlDataSource>
                       </div>
                         <br />
                        <br />
                            <div class="col-12">
