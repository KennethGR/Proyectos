<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarRiesgoGeneral.aspx.cs" Inherits="Gestion_de_riesgos_2.AgregarRiesgoGeneral" %>
				...
				<div id="main" class="wrapper style1">
					<div class="container">
                        <header class="major">
                            <br />
                            <br />
							<h2>Mantenimiento Para Agregar Registro de Diccionario de Diccionario de Riesgos Institucionales</h2>
						</header>
                        <div class="col-12">
                        <ul class="actions" >
                        <li>Ingrese el Código de Causa:</li>
                        <li><asp:TextBox ID="codcausa" class="primary" runat="server" Height="50px" Width="500px"></asp:TextBox></li>
						</ul>
                         <ul class="actions" >
