<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editarriesgoespecifico.aspx.cs" Inherits="Gestion_de_riesgos_2.Editarriesgoespecifico" %>
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
                        ...
                        <br />
						<header class="major">
							<h2>Editar registro de Identificación de Riesgos Específicos</h2>
						</header>
                        ...
                        <div class="col-12">
                                                ...
                                                <asp:TextBox ID="TextBox1" Width="200px" Height="27px" runat="server" class="primary" ReadOnly="True"></asp:TextBox>
                                                <br />
										</div>
						<!-- Form -->
							...
							<section>
                                    <div class="container">
									<div class="col-12">
                                    <h1>Seleccione el área de riesgo específico:</h1>
                                    ...
                                    <br />
                                        ...
                                        <div class="col-12">
                                                <h1>Ultima Fecha de Modificacion:</h1>
										</div>
                                        <div class="col-12">
											<ul class="actions">                                          
                                                <li><asp:TextBox ID="fecha1" runat="server" Width="300px" Height="27px" class="primary"></asp:TextBox></li>
											</ul>
										</div>
                                        <div class="col-12">
											<ul class="actions">
