...
{
    public partial class agregaridentriesgoG : System.Web.UI.Page
    {
        ...
        {
            this.fecha.Text = DateTime.Now.ToLongDateString().ToString();
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        "alert",
                        "alert('Registro Existoso');window.location ='MantGenerales.aspx';",
                        true);
                    }
                    catch
                    {
